...
private:
  ...
  void SetSDLRectFromData (SDL_Rect & sdl_rect,
			   const Json::Value & jsonValue);
  void SetPlayerAnimationDataFromJSON (Animation & animation,
				       Json::Value & jsonValue);
  void SetParticleAnimationDataFromJSON (ParticleAnimation &
					 particleAnimation,
					 Json::Value & jsonValue);
